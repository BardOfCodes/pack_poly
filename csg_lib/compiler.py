...
class CSG2DCompiler:
    def __init__(self, resolution, device):
        ...
        self.draw_seq = ['rectangle', 'ellipse']
    ...
    def ellipse(self, points):
        """Return SDF at points wwith a ellipse centered at origin.
    ...
    def rectangle(self, points):
        """Return SDF at points with a unit rectangle centered at origin.
